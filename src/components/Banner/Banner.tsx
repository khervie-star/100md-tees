...
export const Banner = () => {
  return (
    <div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-green px-6 py-2.5 sm:px-3.5 font-outfit">
      <div className="w-full container mx-auto lgpx-[100px] py-2 flex justify-between text-white items-center gap-x-4 gap-y-2 text-xs lg:text-sm">
        <p className="leading-6 hidden lg:block">
          Custom T-shirts & Promotional Products, Fast & Free Shipping, and
          All-Inclusive Pricing
        </p>
        <div className="flex gap-7 w-fit justify-between lg:justify-end">
